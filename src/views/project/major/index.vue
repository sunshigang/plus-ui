  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item label="建设活动名称" prop="projectName">
              <el-input v-model="queryParams.projectName" placeholder="请输入建设活动名称" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" border :data="infoList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="建设活动名称" align="center" prop="projectName" />
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="infoFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="建设活动名称" prop="projectName">
          <el-input v-model="form.projectName" placeholder="请输入建设活动名称" />
        </el-form-item>
        <el-form-item label="项目代码" prop="projectCode">
